...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Homecooked Heaven</title>
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Vendors</a></li>
        ...
        <section class="inner-page-hero bg-image" data-image-src="images/img/restrrr.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                        <?php
                            // Initialize the variable to store search query
                        ...
                        <!-- <div class="container mt-3">
                            ...
                            <input class="form-control mr-sm-2" type="search" placeholder="find dishes" aria-label="Search">
                            <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                            </form>
                        </div> -->
                        <!-- search end -->
                        <div class="col-xs-12 col-sm-12  col-md-6 col-lg-6 profile-img">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 profile-desc">
                            <div class="pull-left right-text white-txt">
                                ...
                                <p><?php echo 'Open: '.$rows['o_hr'].' to '.$rows['c_hr']; ?></p>
                            </div>
                        </div>
