...
<head>
    ...
    <link rel="icon" href="#">
    <title>Checkout || Homecooked Heaven</title>
            ...
            <div class="container m-t-30" >
                <form action="" method="post">
                    <div class="widget clearfix">
                        ...
                        <div class="widget-body" style="background-color: #DBDCDE;">
                            <form method="post" action="#">
                                <div class="row" >

                                    <div class="col-sm-12 col-md-8">
                                        <div class="cart-totals margin-b-20">
                                            <div class="cart-totals-title m-t-30 m-b-30">
                                        ...
                                        <div class="payment-option">
                                            ...
                                            <p class="text-xs-center"> <input type="submit" onclick="return confirm('Do you want to confirm the order?');" name="submit" style="background-color: #4b9934;" class="btn btn-success btn-block" value="Order Now"> </p>
                                        </div>
                                    
                                    </div>
                                    <div class="col-sm-0 col-md-4">
                                        <img style="width: 100%; height:100%;" src="./images/img/ckout.jpeg">
                                    </div>
                                </div>
                            </form>
                        </div>
